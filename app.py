...
# Strakke CSS om het formulier en de knop naadloos samen te smelten tot één zoekbalk
st.markdown("""
<style>
    ...
    /* Posysionering van het zoekformulier strak rechtsboven */
    ...
    /* Strak rechthoekig zoekveld met afgeronde hoeken */
    .stTextInput input {
    ...
    /* Het vergrootglas exact verwerkt binnen de rechterkant van de zoekbalk */
    .stFormSubmitButton {
...
# Werkende zoekbalk via een formulier
with st.form(key="search_form"):
    ...
    if submitted:
        if search_query.strip():
            ...
            st.warning("⚠️ Typ eerst een geldige bestemming in.")
